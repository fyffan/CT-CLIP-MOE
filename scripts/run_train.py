...
#     data_xlsx="../../Datasets/data/ceshi_n.xlsx"
...
trainer = CTClipTrainer(
    ...
    reports_file_train= "path_to_train_reports_csv",
    reports_file_valid= "path_to_validation_reports_csv",
    data_train= "/data1/users/fangyifan/Works/Paper_Code/Datasets/test60",
    data_valid = "path_to_preprocessed_valid",
    data_xlsx="/data1/users/fangyifan/Works/Paper_Code/Datasets/test60/ceshi_n.xlsx",
    labels = "path_to_validation_labels_csv",
    batch_size = 1,
    results_folder="output_folder",
    num_train_steps = 100001,
